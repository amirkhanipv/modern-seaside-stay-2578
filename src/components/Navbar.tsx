...
export default function Navbar() {
  ...
  return <header className={cn("fixed top-0 left-0 right-0 z-50 transition-all duration-300", scrolled ? "bg-background/90 backdrop-blur-lg py-3 shadow-md border-b border-border" : "bg-transparent py-5")}>
