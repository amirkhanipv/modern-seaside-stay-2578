...
const PORTFOLIO_CATEGORIES: Record<PortfolioCategoryKey, PortfolioCategory> = {
  children: {
    title: "کودک",
    images: ["https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400&h=400&fit=crop", "https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?w=400&h=400&fit=crop", "https://images.unsplash.com/photo-1587393855524-087f83d95bc9?w=400&h=400&fit=crop", "https://images.unsplash.com/photo-1503919005314-30d93d07d823?w=400&h=400&fit=crop"]
  },
  wedding: {
    title: "عروس",
    images: ["https://images.unsplash.com/photo-1519741497674-611481863552?w=400&h=400&fit=crop", "https://images.unsplash.com/photo-1465495976277-4387d4b0e4a6?w=400&h=400&fit=crop", "https://images.unsplash.com/photo-1520854221256-17451cc331bf?w=400&h=400&fit=crop", "https://images.unsplash.com/photo-1606216794074-735e91aa2c92?w=400&h=400&fit=crop"]
  },
  sport: {
    title: "اسپرت",
    images: ["https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&h=400&fit=crop", "https://images.unsplash.com/photo-1594736797933-d0ed94ac1274?w=400&h=400&fit=crop", "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400&h=400&fit=crop", "https://images.unsplash.com/photo-1566754219187-f30ba1c0bd5f?w=400&h=400&fit=crop"]
  },
  family: {
    title: "خانوادگی",
    images: ["https://images.unsplash.com/photo-1511895426328-dc8714191300?w=400&h=400&fit=crop", "https://images.unsplash.com/photo-1609220136736-443140cffec6?w=400&h=400&fit=crop", "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop", "https://images.unsplash.com/photo-1581833971358-2c8b550f87b3?w=400&h=400&fit=crop"]
  }
};
...
export default function NoraStudio() {
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      try {
        const [reviewsData, plansData] = await Promise.all([fetchCustomerReviews(), fetchDiscountPlans()]);
  ...
  const activeCategory = useMemo(() => PORTFOLIO_CATEGORIES[activeCategoryKey], [activeCategoryKey]);
  ...
  const goToPreviousSlide = useCallback(() => {
    setActiveSlideIndex(prev => (prev - 1 + activeCategoryImageCount) % activeCategoryImageCount);
  }, [activeCategoryImageCount]);
  ...
  return <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4 animate-fade-in">
          ...
          <p className="text-xl md:text-2xl mb-8 text-white/90 animate-fade-in anim-delay-120 font-extrabold">
            لحظه‌های خاص شما در قاب هنر
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in anim-delay-180">
            <Button className="text-lg px-8 py-4 bg-white hover:bg-white/95 border border-white/40 transition-all duration-300" onClick={() => document.getElementById("portfolio")?.scrollIntoView({
            behavior: "smooth"
          })} style={{
            color: '#000000'
          }}>
              <Camera className="ml-2 h-5 w-5" style={{
              color: '#000000'
            }} />
              <span style={{
              color: '#000000'
            }}>مشاهده نمونه کارها</span>
            </Button>
            <Button className="text-lg px-8 py-4 bg-white/20 text-white border border-white/30 hover:bg-white/30 backdrop-blur-sm" onClick={() => window.location.href = "/booking"}>
              رزرو نوبت
            </Button>
            <Button className="text-lg px-8 py-4 bg-white/20 text-white border border-white/30 hover:bg-white/30 backdrop-blur-sm" onClick={() => window.location.href = "/booking-status"}>
              پیگیری رزرو
            </Button>
          </div>
        </div>
      ...
      {reviews.length > 0 && <section className="section bg-gradient-to-b from-muted/20 via-muted/40 to-muted/20 overflow-hidden relative">
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            <div className="absolute bottom-10 left-10 w-40 h-40 bg-primary/5 rounded-full blur-3xl animate-pulse" style={{
          animationDelay: '1s'
        }} />
          </div>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-6 text-center border-2 border-blue-200 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <a href="tel:09999999999" className="inline-flex items-center bg-blue-600 text-white rounded-xl px-4 py-2 hover:bg-blue-700 hover:shadow-lg transition-all duration-300 mb-4 text-sm font-bold">
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-6 text-center border-2 border-green-200 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <a href="https://wa.me/989999999999" target="_blank" rel="noopener noreferrer" className="inline-flex items-center bg-green-600 text-white rounded-xl px-4 py-2 hover:bg-green-700 hover:shadow-lg transition-all duration-300 mb-4 text-sm font-bold">
            ...
            <div className="bg-gradient-to-br from-sky-50 to-sky-100 rounded-2xl p-6 text-center border-2 border-sky-200 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <a href="https://t.me/NoraStudio" target="_blank" rel="noopener noreferrer" className="inline-flex items-center bg-sky-600 text-white rounded-xl px-4 py-2 hover:bg-sky-700 hover:shadow-lg transition-all duration-300 mb-4 text-sm font-bold">
            ...
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-6 text-center border-2 border-purple-200 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <a href="https://instagram.com/Nora_Stu" target="_blank" rel="noopener noreferrer" className="inline-flex items-center bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl px-4 py-2 hover:shadow-lg transition-all duration-300 mb-4 text-sm font-bold">
